...
//    }
    ...
    void traverseAllChildren(int childCount, int layoutDirection) {
        if (childCount > 3) {
    ...
    void cancelRunningAnimatorAndPendingActions() {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (mShownDrawer == null) {
            ...
            try {
                ...
                // open, the content view will receive no touch event while we are touching on it.
